#######################################################################################################################################################################
# Description: An implementation of QuickSort in which the pivot is selected as the first element of the (sub-)array.
# File: quicksort_first.py
#######################################################################################################################################################################
...
def partition(alist, first, last):
    # Sets pivot equal to the first item in the (sub-)array.
